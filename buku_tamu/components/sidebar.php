    ...
    <nav class="sidenav shadow-right sidenav-light">
        <div class="sidenav-menu">
            <div class="nav accordion" id="accordionSidenav">
                ...
                <!-- Sidenav Link (Tables)-->
                <a class="nav-link <?= $lastURL === "index.php" ? "active" : "" ?> ?>" href="index.php">
                    <div class="nav-link-icon"><i data-feather="home"></i></div>
                    Dashboard
                </a>
                <a class="nav-link <?= $lastURL === "history.php" ? "active" : "" ?> ?>" href="history.php">
                    <div class="nav-link-icon"><i data-feather="clipboard"></i></div>
                    History
                </a>
                <?php if (isset($_SESSION['admin_session'])) { ?>
                    <!-- Sidenav Admin Menu Heading (Core)-->
                    ...
                    <div class="collapse" id="pagesCollapseError" data-bs-parent="#accordionSidenavPagesMenu">
                        <nav class="sidenav-menu-nested nav">
                            <a class="nav-link" href="edit_data.php">Edit Departemen</a>
                            <a class="nav-link" href="edit_data.php">Edit Jabatan</a>
                        </nav>
                    </div>
                <?php } ?>
            </div>
        ...
        <div class="sidenav-footer">
            <div class="sidenav-footer-content">
                <div class="sidenav-footer-subtitle">Powered By:</div>
                <div class="sidenav-footer-title">Entri.Id</div>
            </div>
        </div>
    </nav>
</div>